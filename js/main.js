(function($) {
    ...
    loginForm.addEventListener("submit", (e) => {
        e.preventDefault();
        let data = { type: "success", message: "Message successfully sent" };
        let messageAlert = 'alert-' + data.type;
        let messageText = data.message;
        let alertBox = document.createElement("div");
        alertBox.classList.add("alert", messageAlert, "alert-dismissable");
        alertBox.style.paddingBottom = "35px"; // Add padding-bottom style
        alertBox.style.color = "#44f144";
        alertBox.innerHTML = messageText;
